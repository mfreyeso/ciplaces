...
class CollectivePlaces(object):
    ...
    def search_places_radar(self, location, keyword, min_price, max_price):
        return self.client.places_radar(location, self.radius,
                                        keyword=keyword,
                                        min_price=min_price,
                                        max_price=max_price)

    def search_places_by_text(self, textplace, location, min_price, max_price):
